---
ID: 29
post_title: Another aspect to Spring
author: Daniel Watford
post_date: 2010-03-02 16:25:00
post_excerpt: ""
layout: post
permalink: >
  http://www.foomoo.com/2010/03/another-aspect-to-spring/
published: true
blogger_blog:
  - www.foomoo.com
blogger_author:
...
blogger_permalink:
  - /2010/03/another-aspect-to-spring.html
---
...
<pre class="brush: plain">02-Mar-2010 16:07:01 org.springframework.context.support.AbstractApplicationContext prepareRefresh
...
<pre class="brush: java">package com.foomoo.example.spring.helloSpring.advice;
...
public class ChatterBoxCounterAdvice {
 ...
 public void report() {new PrintStream(outputStream).println("Characters Counted: " + characterCount);}
